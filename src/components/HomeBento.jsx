...
export default function HomeBento({ setActivePage, onSearchNavigate, onOpenStoreFinder }) {
  ...
  const product1 = PRODUCTS.find(p => p.id === 1) || { name: 'Kursi Santai Skandinavia', price: 'Rp 4.590.000' };
  const product2 = PRODUCTS.find(p => p.id === 2) || { name: 'Sofa 3-Dudukan – Cloud Grey', price: 'Rp 13.890.000' };
  ...
  return (
    <main className="hero-bento" id="hero-bento">
      ...
      <div className="bento-row row-1">
        ...
        {/* CARD 1: Main Furniture Hero Banner */}
        <div className="bento-card main-hero-card" id="card-hero-main">
          ...
          <div className="hero-content">
            <h1 className="hero-title">Kenyamanan Diciptakan untuk Hunian Modern</h1>
            <p className="hero-subtitle">
              Jelajahi furnitur pilihan yang menghadirkan keanggunan dan kehangatan di rumah Anda.
            </p>
            <button 
              type="button"
          ...
          <div className="hero-stats">
            <div className="stat-item">
              ...
              <span className="stat-label">Desain Abadi</span>
            </div>
            <div className="stat-item">
              <span className="stat-number">1000+</span>
              <span className="stat-label">Rumah Impian<br />Terwujud</span>
            </div>
            <div className="stat-item">
              <span className="stat-number">50+</span>
              <span className="stat-label">Pengiriman ke Seluruh<br />Dunia</span>
            </div>
          </div>
        </div>

        {/* CARD 2: Promo Armchair Card */}
        <div className="bento-card promo-card" id="card-promo">
          <div className="promo-top-tag">MEGA DISKON HINGGA 70%</div>
          <div className="promo-img-wrapper">
            <img src="assets/promo_armchair.png" alt="Kursi Favorit" className="promo-img transparent-bg-img" />
          </div>
          <div className="promo-bottom">
            <h2 className="promo-title">Temukan Kursi Favorit Anda</h2>
            <p className="promo-desc">Hemat hingga 20% untuk semua set meja makan akhir pekan ini.</p>
            <div 
              className="promo-cta" 
              id="btn-promo-cta"
              onClick={() => setActivePage('shop')}
      ...
      <div className="bento-row row-2">
        ...
        <div className="bento-card gallery-card" id="card-gallery">
          ...
          <div className="gallery-content">
            <h2 className="gallery-title">Dapatkan Inspirasi</h2>
            <button 
              type="button"
        ...
        <div className="bento-column brand-testimonials-column">
          ...
          <div className="bento-card brand-banner-card" id="card-brand-banner">
            <div className="brand-logo-wrap">
              ...
              <span className="brand-title">FIFA</span>
            </div>
            <span className="brand-subtitle">HUNIAN ELEGAN.</span>
          </div>
          ...
          <div className="testimonials-row">
            ...
            <div className="bento-card testimonial-card test-peach" id="card-testimonial-1">
              <div className="test-header">
                ...
                <div className="test-user">
                  ...
                  <span className="user-rating"><span className="star">⭐</span> 4.9</span>
                </div>
              </div>
              <p className="test-text">Kursinya sangat nyaman, bahannya mewah & bikin ruang tamu makin cantik!</p>
            ...
            <div className="bento-card testimonial-card test-cyan" id="card-testimonial-2">
              <div className="test-header">
                <div className="avatar avatar-rian">
                  <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
                    <circle cx="18" cy="18" r="18" fill="url(#avatar-grad)" />
                    <defs>
                      <linearGradient id="avatar-grad" x1="0" y1="0" x2="36" y2="36" gradientUnits="userSpaceOnUse">
                ...
                <div className="test-user">
                  <span className="user-name">Rian Pratama</span>
                  <span className="user-rating"><span className="star">⭐</span> 4.8</span>
                </div>
              </div>
              <p className="test-text">Meja makan kokoh & elegan. Pengiriman cepat, sangat puas!</p>
        ...
        <div className="bento-column feature-store-contact-group">
          ...
          <div className="bento-card feature-teal-card" id="card-feature-teal">
            <div className="teal-content">
              <h2 className="teal-title">Buat Ruangan Anda<br />Nyaman & Fungsional</h2>
              <p className="teal-desc">
                Dengan fokus pada desain dan fungsi, PunPun menawarkan keseimbangan antara kenyamanan dan kepraktisan
              </p>
              <div className="search-bar" id="hero-search-bar" onClick={() => setActivePage('shop')}>
                ...
                <input 
                  type="text" 
                  placeholder="Cari sofa, meja, lampu... (Tekan Enter)" 
          ...
          <div className="store-contact-row">
            ...
            >
              <div className="pin-circle">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#4DBBDD" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" />
                  <circle cx="12" cy="10" r="3" />
                </svg>
              </div>
              <h3 className="store-title">Temukan Toko<br />Terdekat</h3>
            </div>
            ...
            <div className="bento-card contact-card" id="card-contact">
              <div className="contact-top">
                ...
                <div className="contact-details">
                  ...
                  <span>fifafurniture@gmail.com</span>
              ...
              <div className="social-bar">
                ...
                <a href="#amazon" className="social-box" aria-label="Amazon" onClick={(e) => e.preventDefault()}>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M21 16c-3 2.5-7 3.5-10.5 2C7.5 16.5 4.5 13.5 3 10" />
                    <path d="M18 14l3 2.5-3 2.5" />
                  </svg>
                </a>
              </div>
            </div>
